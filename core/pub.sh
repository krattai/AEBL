...
mosquitto_pub -d -t ihdn/sixxs -m "$(date) : sixxs $hostn IPv4 $ext_ip4 is online." -h "ihdn.ca"
mosquitto_pub -d -t ihdn/sixxs -m "$(date) : sixxs $hostn IPv6 $ext_ip6 is online." -h "ihdn.ca"
