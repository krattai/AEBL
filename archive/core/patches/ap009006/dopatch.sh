...
# add IPv6 tunnel via freenet6 for "internet of things" label
...
#     $HOME/tmpdir_maintenance/mod_Twitter/./tcli.sh -c statuses_update -s "automagic @kratt, ${MACe0} patched to Internet of Things via ${pv}." &
# fi
