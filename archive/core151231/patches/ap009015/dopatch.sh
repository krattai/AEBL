...
mv cronrem.sh $HOME/.scripts
chmod 777 $HOME/.scripts/cronrem.sh
cp $HOME/.scripts/* $HOME/scripts
cp $HOME/.scripts/cronrem.sh $T_SCR

mv cronadd.sh $HOME/.scripts
chmod 777 $HOME/.scripts/cronadd.sh
cp $HOME/.scripts/* $HOME/scripts
cp $HOME/.scripts/cronadd.sh $T_SCR

mv chckint.ctab $HOME/.scripts
cp $HOME/.scripts/chckint.ctab $HOME/scripts
cp $HOME/.scripts/chckint.ctab $T_SCR

mv lctrl.ctab $HOME/.scripts
cp $HOME/.scripts/lctrl.ctab $HOME/scripts
cp $HOME/.scripts/lctrl.ctab $T_SCR

if [ -f "${IHDN_TEST}" ] || [ -f "${IHDN_SYS}" ]; then

    $HOME/.scripts/./cronrem.sh

    $HOME/.scripts/./cronadd.sh
