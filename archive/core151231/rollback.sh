#!/bin/bash
# rolls back patches to specific version
#
# Copyright (C) 2015 Uvea I. S., Kevin Rattai
# BSD license https://raw.githubusercontent.com/krattai/AEBL/master/LICENSE
#
# Not yet sure how this will work, this would be to fix a bad patch
#   ie.  if patch.sh has errors and can not be recovered from with new patch 
#
