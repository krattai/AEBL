...
?><html>
<head>
<title>AEBL Navigator- Login</title>
...
<table width="300"  border="0" class="window">
  <tr>
    <td><table width="300"  border="0" align="center" cellpadding="0" cellspacing="0" class="lefthead">
      <tr>
        <td class="head" valign=middle><center class="title"><img src=images/logoff.gif align=left><strong>AEBL Navigator - Login</strong></center></td>
      </tr>
    </table>
