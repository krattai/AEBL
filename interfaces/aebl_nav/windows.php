...
#  AEBL Navigator 0.91
#  ------------------
#  Copyright (C) 2014 Uvea I. S., Kevin Rattai (retaining GPLv2 license)
#  https://github.com/krattai/AEBL/tree/master/interfaces/aebl_nav
#  
#  AEBL Navigator is a web interface tool to manage content and playlists
#    on an AEBL
#  AEBL Navigator is integrated into the AEBL-ATS-VM virtual machine
#  https://github.com/krattai/AEBL/tree/master/interfaces/ATS_VM
#  ------------------
#  AEBL Navigator is a fork of PHP Navigator 4.44
#  ------------------
#  Original copyright notification follows fork modification information
#
#  changelog
#  + modified branding
#  ------------------
...
if($action=="Open"&&!is_dir("$dir/$file")) print"<title>Edit- AEBL Navigator</title>
...
<title>AEBL Navigator</title><body onLoad=init_navphp() topmargin=0 leftmargin=0 rightmargin=0>";
...
print"<center><table width=100% class=window><tr><td colspan=3 class=head height=20>
	<center>AEBL Navigator v0091 <font color=orange><i>xp</i></font></td></tr>
