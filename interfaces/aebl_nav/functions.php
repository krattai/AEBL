...
#
#  changelog
#  + modified to add pull.sh script
#  + removed all unnecessary function code
#  ------------------
#  ++++++++++++++++++
#---------------------------
# PHP Navigator 4.44
...
<a href='windows.php?push=true'><img src=images/explore.gif width=16 height=16> <u>Push files to server</u></a></td><tr>";
print"<tr><td class=leftsub><div   width=100% class=info id=tasks>
